    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-16 scroll-reveal">
            ...
            @else
                ...
                <p class="text-gray-600 text-xl max-w-3xl mx-auto">
                    Dengarkan langsung dari para pemimpin perusahaan yang telah merasakan transformasi bisnis bersama
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 scroll-reveal">
            @forelse($testimonis as $testimoni)
                <div
                    class="testimonial-card bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 scroll-reveal">
                    <div class="flex items-center mb-6">
                        <div class="relative">
                            @if ($testimoni->foto)
                                <img src="{{ asset('storage/' . $testimoni->foto) }}"
                                    alt="{{ $testimoni->nama_testimoni }}, {{ $testimoni->jabatan }}"
                                    class="w-16 h-16 rounded-full object-cover ring-4 ring-rose-100" />
                            @else
                                <div
                                    class="w-16 h-16 rounded-full object-cover ring-4 ring-rose-100 bg-gray-300 flex items-center justify-center">
