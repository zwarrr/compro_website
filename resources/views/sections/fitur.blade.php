            ...
            <div class="space-y-8">
                ...
                <div class="grid sm:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-start gap-4 group">
                        <div class="w-6 h-6 bg-gray-400 rounded-full flex items-center justify-center flex-shrink-0 mt-1 transition-colors duration-300 group-hover:bg-red-500">
...
(function() {
    const initFiturSection = () => {
        ...
        const illustrationElements = document.querySelectorAll('.animate-bounce, .animate-pulse, .animate-ping');
