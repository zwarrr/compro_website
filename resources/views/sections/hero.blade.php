            ...
            <div class="relative flex items-center justify-center">
                ...
                <div>
                    <div class="animate-floating">
                        ...
                        <div
                            class="hidden w-full max-w-sm md:max-w-md lg:max-w-lg h-80 bg-gradient-to-br from-rose-100 via-blue-100 to-purple-100 rounded-2xl flex items-center justify-center mx-auto">
                            <div class="text-center p-8">
                                <div
                                    class="w-24 h-24 bg-gradient-to-br from-rose-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
