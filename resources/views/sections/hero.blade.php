...
<!-- Hero Section -->
<section id="beranda"
    class="pt-28 pb-20 bg-gradient-to-br from-gray-50 to-white min-h-screen flex items-center relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div class="grid md:grid-cols-2 gap-12 items-center min-h-[70vh]">
            ...
            <div class="space-y-8 text-center md:text-left scroll-reveal">
                @if (isset($page) && $page)
                    <h1
                        class="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 bg-clip-text text-transparent">
                        {{ $page->judul }}
                    </h1>
                    <p class="text-lg md:text-xl max-w-2xl text-gray-600 mx-auto md:mx-0 leading-relaxed">
                        {{ $page->sub_judul }}
                    </p>
                    <p class="text-base md:text-lg max-w-2xl text-gray-600 mx-auto md:mx-0 leading-relaxed">
                        {{ $page->deskripsi }}
                    </p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                        @if ($page->button_primary_link && $page->button_primary_text)
                            <a href="{{ $page->button_primary_link }}" target="_blank"
                                ...
                                <span>{{ $page->button_primary_text }}</span>
                                <i class="fas fa-arrow-right text-sm"></i>
                            </a>
                        @endif
                        @if ($page->button_secondary_link && $page->button_secondary_text)
                            <a href="{{ $page->button_secondary_link }}"
                                ...
                                <span>{{ $page->button_secondary_text }}</span>
                            </a>
                        @endif
                    </div>
                @else
                    ...
                    <p class="text-lg md:text-xl max-w-2xl text-gray-600 mx-auto md:mx-0 leading-relaxed">
                        Solusi lengkap untuk kebutuhan teknologi digital Anda. Platform terintegrasi untuk pulsa,
                        pembayaran, voucher, dan layanan UMKM dengan teknologi terdepan.
                    </p>
            ...
            <div class="relative flex items-center justify-center scroll-reveal">
                <div class="carousel-container w-full max-w-lg aspect-square">
                    <!-- Gambar 1 -->
                    <img src="{{ asset('img/ilustrasi_landing_page.svg') }}" alt="PT. Technology Multi System Logo"
                        class="carousel-img">

                    <!-- Gambar 2 -->
                    <img src="{{ asset('img/ilustrasi_landingpage_team.svg') }}"
                        alt="PT. Technology Multi System Logo 2" class="carousel-img">
                </div>
            </div>
        </div>
    </div>
