        ...
        <section class="relative bg-gray-50 min-h-screen pt-24 pb-16">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 gap-8 mb-24">
                    <!-- Visi -->
                    <div
                        class="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-500 scroll-animate">
                        <div class="flex items-center mb-6">
                            <div
                                class="w-14 h-14 bg-blue-500 rounded-2xl flex items-center justify-center mr-4 shadow-lg">
                    ...
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                class="w-14 h-14 bg-red-500 rounded-2xl flex items-center justify-center mr-4 shadow-lg">
                ...
                <div class="mb-24">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <!-- Inovasi -->
                        <div
                            class="text-center p-8 bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 scroll-animate">
                            <div
                                class="w-20 h-20 bg-blue-500 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                                <i class="fas fa-lightbulb text-white text-2xl"></i>
                            </div>
                        ...
                        <div
                            class="text-center p-8 bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 scroll-animate">
                            <div
                                class="w-20 h-20 bg-green-500 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                                <i class="fas fa-award text-white text-2xl"></i>
                            </div>
                        ...
                        <div
                            class="text-center p-8 bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 scroll-animate">
                            <div
                                class="w-20 h-20 bg-purple-500 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                        ...
                        <div
                            class="text-center p-8 bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 scroll-animate">
                            <div
                                class="w-20 h-20 bg-red-500 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                ...
                <div class="mb-24">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        <div
                            class="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 text-center hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 scroll-animate">
                            <div
                                class="w-20 h-20 bg-yellow-500 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                                <i class="fas fa-certificate text-white text-2xl"></i>
                            </div>
                            <h4 class="text-xl font-bold text-gray-900 mb-4">ISO 9001:2015</h4>
                            <p class="text-gray-600 leading-relaxed">Sertifikasi manajemen kualitas internasional untuk
                                standar operasional terbaik</p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-gray-600 leading-relaxed">Sertifikasi keamanan informasi untuk perlindungan
                                data optimal</p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-gray-600 leading-relaxed">Penghargaan perusahaan IT terbaik tahun 2023 dari
                                Indonesia Tech Awards</p>
                        </div>
                    </div>
                </div>
