        ...
        <section id="lowongan" class="flex-grow py-16 px-6 bg-white relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto relative z-10">
                <div class="text-center mb-16">
                    @if (isset($loker) && $loker)
                        <h1
                            class="text-5xl md:text-6xl font-extrabold tracking-tight leading-tight mb-6 drop-shadow-lg animate-fadeInDown text-gray-900">
                            Informasi <span class="text-red-600">Lowongan Kerja</span>
                        </h1>
                        <p
                            class="text-lg md:text-xl max-w-3xl mx-auto font-medium leading-relaxed text-gray-700 animate-fadeInUp">
                            {{$loker->deskripsi}}
                        </p>
                    @else
                        <h1
                        ...
                        <p
                            class="text-lg md:text-xl max-w-3xl mx-auto font-medium leading-relaxed text-gray-700 animate-fadeInUp">
                            Temukan berbagai lowongan pekerjaan yang tersedia di perusahaan kami. Kami mencari individu
                            yang
                 ...
                 cursor-pointer group">
                            <div class="p-6 flex flex-col flex-grow">
                                <div class="flex items-center mb-4 space-x-4">
                                    <img src="{{ asset('img/logo_oplok.png') }}" alt="Logo TMS"
                                        class="rounded-full w-16 h-16 object-cover border-2 border-red-300 transition-all duration-300 group-hover:brightness-110">
                                    <div>
                                        <h3 class="text-xl font-semibold text-red-700 transition-all duration-300">
                                            {{ $loker->posisi }}</h3>
                                        <p
                                            class="text-sm text-gray-500 transition-all duration-300 group-hover:text-red-500">
                                            {{ $loker->perusahaan }}</p>
                                    </div>
                                </div>
                                    ...
                                    <li class="flex transition-all duration-300 group-hover:translate-x-1">
                                        ...
                                        <span>
                                            @if ($loker->gaji_awal && $loker->gaji_akhir)
                                                Rp {{ number_format($loker->gaji_awal, 0, ',', '.') }} - Rp
                                                {{ number_format($loker->gaji_akhir, 0, ',', '.') }}
                            ...
                            <div
                                class="p-6 border-t border-gray-100 bg-red-50 rounded-b-xl transition-all duration-300 group-hover:bg-red-100">
                                <button onclick="openModalLamaran('{{ $loker->posisi }}', {{ $loker->id_loker }})"
                    ...
                    @empty
                        ...
                        <div class="col-span-full text-center py-16">
                            ...
                            <p class="text-gray-500">Saat ini belum ada lowongan kerja yang tersedia. Silakan cek
                                kembali nanti.</p>
                        </div>
                    @endforelse
