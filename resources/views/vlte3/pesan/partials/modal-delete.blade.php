    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-trash mr-2"></i>Hapus Pesan</h5>
                <button type="button" class="close" data-dismiss="modal" onclick="closeDeleteModal()">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="deletePesanForm" onsubmit="submitDelete(event)">
                @csrf
                <input type="hidden" id="delete_pesan_id" name="id">
                <div class="modal-body">
                    <div class="alert alert-danger d-flex align-items-center" role="alert">
                        <i class="fas fa-exclamation-triangle mr-2"></i>
                        <div>
                            Apakah Anda yakin ingin menghapus pesan dari <strong id="delete_pesan_nama"></strong>?<br>
