<div class="modal fade" id="createModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="max-width: 800px; margin: auto;">
            ...
            <form id="createGaleriForm" onsubmit="submitCreate(event)" style="width:100%;">
                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="file" class="form-control-file" id="gambar" name="gambar"
                                            accept="image/*" onchange="previewCreateImage(event)">
                                    </div>
                                    <div class="text-center mb-2">
                                        <img id="preview-create-img" src="#" alt="Preview"
