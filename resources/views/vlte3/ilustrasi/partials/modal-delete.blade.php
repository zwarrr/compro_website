    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Hapus Ilustrasi</h5>
            ...
            <div class="modal-body">
                ...
                <p class="text-center">Apakah Anda yakin ingin menghapus ilustrasi <strong id="delete_ilustrasi_name"></strong>?</p>
                <div id="delete_gambar" class="text-center mb-3"></div>
                <div class="alert alert-warning mt-3" role="alert">
                    <i class="fas fa-exclamation-circle mr-2"></i>
                    <strong>Peringatan:</strong> Data yang dihapus tidak dapat dikembalikan!
                </div>
                <input type="hidden" id="delete_ilustrasi_id">
            </div>
