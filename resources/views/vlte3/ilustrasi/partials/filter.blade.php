    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" onclick="openCreateModal()">
                <i class="fas fa-plus"></i> Tambah Ilustrasi
            </button>
        </div>
    </div>
    <div class="card-body">
        <form method="GET" action="{{ route('admin.ilustrasi.index') }}" id="filterForm">
            <div class="row">
                <!-- Search -->
                <div class="col-md-5">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}"
                                placeholder="Cari judul/kode ilustrasi..." class="form-control"
                                id="searchInput">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group mb-0">
                        <div class="input-group">
                            ...
                            <select name="sort" class="form-control mr-2" id="sortSelect">
                                ...
                                <option value="kode_ilustrasi" {{ request('sort') == 'kode_ilustrasi' ? 'selected' : '' }}>Kode Ilustrasi</option>
                            </select>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="{{ route('admin.ilustrasi.index') }}" class="btn btn-secondary btn-sm ml-2">
