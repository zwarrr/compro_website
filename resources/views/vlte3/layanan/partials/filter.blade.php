        ...
        <form method="GET" action="{{ route('admin.layanan.index') }}" id="filterForm">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}"
                                placeholder="Cari judul/kode layanan..." class="form-control"
                                id="searchInput">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group mb-0">
                        <div class="input-group">
                            ...
                            <select name="sort" class="form-control mr-2" id="sortSelect">
                                ...
                                <option value="kode_layanan" {{ request('sort') == 'kode_layanan' ? 'selected' : '' }}>Kode Layanan</option>
                            </select>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="{{ route('admin.layanan.index') }}" class="btn btn-secondary btn-sm ml-2">
