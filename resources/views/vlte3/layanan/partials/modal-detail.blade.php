        ...
        <div class="modal-content" style="max-width: 800px; margin: auto;">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="fas fa-eye mr-2"></i>Detail Layanan
                </h5>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="" id="detail_id" readonly placeholder="ID Layanan">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="" id="detail_kode" readonly placeholder="Kode Layanan">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="" id="detail_slog" readonly placeholder="Slogan">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="" id="detail_link" readonly placeholder="Link">
                                </div>
                                <div id="detail_link_anchor" class="mt-1"></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" value="" id="detail_updated_at" readonly placeholder="Terakhir Diupdate">
                                </div>
                            </div>
                        </div>
                        <div class="row">
