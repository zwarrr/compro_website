    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="max-width: 800px; margin: auto;">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-eye mr-2"></i>Detail Testimoni</h5>
                ...
                <div class="container-fluid px-2">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <strong>Nama:</strong> <span id="detail_nama_testimoni"></span><br>
                            <strong>Jabatan:</strong> <span id="detail_jabatan"></span><br>
                            <strong>Status:</strong> <span id="detail_status"></span><br>
                            <strong>Rating:</strong> <span id="detail_rating"></span><br>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <strong>Pesan:</strong>
                            <div id="detail_pesan" class="border rounded p-2 bg-light"></div>
                        </div>
                    </div>
                </div>
            </div>
