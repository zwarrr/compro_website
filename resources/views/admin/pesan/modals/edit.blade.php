<div id="editModal"
    ...
    <div id="editModalContent" class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 my-8 transform transition-all duration-300 scale-95 opacity-0 max-h-[90vh] overflow-y-auto">
        ...
        <div class="sticky top-0 z-10 flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-white rounded-t-2xl">
            <div class="flex items-center gap-3">
                ...
                <h3 class="text-xl font-bold text-gray-800">Edit Pesan</h3>
            </div>
        ...
        <div class="p-6">
            ...
            <!-- Edit Form -->
            <form id="editPesanForm" class="hidden" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Kode Kontak (Read Only) -->
                    <div class="space-y-2 md:col-span-2">
                        <label class="block text-sm font-semibold text-gray-700">Kode Kontak</label>
                        <div class="bg-gray-50 rounded-lg p-4">
                            <p class="text-base font-semibold text-gray-900" id="edit_kode_kontak_display"></p>
                        </div>
                    </div>
                    ...
                    <!-- Email -->
                    <div class="space-y-2 md:col-span-2">
                        <label for="edit_email" class="block text-sm font-semibold text-gray-700">
                    ...
                    <!-- Subjek -->
                    <div class="space-y-2 md:col-span-2">
                        <label for="edit_subjek" class="block text-sm font-semibold text-gray-700">
                            Subjek
                        </label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <input type="text" id="edit_subjek" name="subjek"
                                class="w-full pl-10 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:border-red-500 transition-all outline-none"
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <div class="flex gap-6">
                            <label class="flex items-center cursor-pointer group">
                                <input type="radio" name="status_baca" value="belum" id="edit_status_belum"
                                    class="w-4 h-4 text-primary">
                                <span class="ml-2 text-sm text-gray-700 group-hover:text-gray-900">Belum Dibaca</span>
                            </label>
                            <label class="flex items-center cursor-pointer group">
                                <input type="radio" name="status_baca" value="sudah" id="edit_status_sudah"
                                    class="w-4 h-4 text-primary">
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3 mt-8 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" id="editPesanSubmitBtn"
                        ...
                        <svg id="editPesanLoadingSpinner" class="animate-spin -ml-1 mr-2 h-5 w-5 text-white hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
                        <span id="editPesanSubmitBtnText">Simpan Perubahan</span>
                    </button>
                </div>
            </form>
        </div>
