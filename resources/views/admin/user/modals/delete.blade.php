...
<div id="deleteModal" class="fixed inset-0 bg-gray-900 bg-opacity-60 hidden items-center justify-center z-50 transition-opacity duration-300 backdrop-blur-sm">
    <div class="modal-content bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 transform transition-all duration-300 scale-95 opacity-0">
        ...
        <div class="p-8">
            ...
            <div class="text-center mb-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-4">
                    <span class="font-bold text-lg text-gray-900" id="delete_user_name"></span>
                </div>
            ...
            <!-- Hidden Form -->
            <form id="deleteUserForm" onsubmit="submitDelete(event)" class="hidden">
        ...
        <div class="flex justify-end gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50 rounded-b-xl">
            ...
            <button type="button" onclick="submitDelete(event)" id="deleteSubmitBtn"
                ...
                <span id="deleteSubmitBtnText">Hapus Pengguna</span>
            </button>
        </div>
    </div>
</div>