    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="{{ url('/') }}" class="h1">
                    <img src="/images/logo.png" alt="Logo" width="30px" class="h-16 mb-2" style="display: inline-block; vertical-align: middle;">
                    <b>Admin</b>Panel
                </a>
            </div>
            <div class="card-body">
                <p class="login-box-msg">Silakan login untuk melanjutkan ke dashboard admin</p>
